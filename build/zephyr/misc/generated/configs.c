...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BME68X_IAQ, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BME68X_IAQ_SAVE_INTERVAL_MINUTES, 60);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BME68X_IAQ_THREAD_STACK_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BME68X_IAQ_EXPECTED_AMBIENT_TEMP, 25);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BME68X_IAQ_TEMPERATURE_OFFSET, 100);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BME68X_IAQ_SAMPLE_RATE_LOW_POWER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BME68X_IAQ_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BME68X_IAQ_LOG_LEVEL, 3);
